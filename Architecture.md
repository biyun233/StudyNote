...
- LVS/NAT
	...
	​				显著缺点：LVS 会成为整个应用集群的性能瓶颈，当流量异常增加时，单台 LVS 无法承载巨大的请求和响应。
...
​			`缺点`：服务单一性不够，且过度的 web 层业务聚合会导致服务不便于管理
...
​			`缺点`：聚合服务处理不够灵活，需要有 service provider 提供聚合服务能力
